...
class _SuperAdminPanelScreenState extends State<SuperAdminPanelScreen>
    ...
    return BlocListener<SuperAdminCubit, SuperAdminState>(
      ...
      appBar: TabBar(
        ...
        tabs: const [
          ...
          Tab(text: "Platform SEO", icon: Icon(Icons.travel_explore_rounded)),
  ...
  Widget _buildSeoTab(SuperAdminLoaded state) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(24),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Platform SEO Settings", style: AppTypography.h3),
              PrimaryButton(
                text: "Add New Route",
                width: 150,
          ...
          const SizedBox(height: 16),
          Text(
            "Manage the dynamic SEO metadata for the main platform routes. These changes reflect instantly in the Vercel Edge Middleware for Googlebot and Social Scrapers.",
            style: AppTypography.bodyMedium.copyWith(color: AppColors.textSecondary),
          ),
          const SizedBox(height: 24),
          ResponsiveDataTable(
