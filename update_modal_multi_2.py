...
search_pattern = "    {'type': 'lead_magnet',"
multi_step_str = "    {'type': 'multi_step_lead_form', 'name': 'نموذج متعدد الخطوات', 'icon': Icons.dynamic_form_rounded, 'category': 'conversion', 'desc': 'جمع بيانات العملاء باحترافية على مراحل.', 'popular': true},\n"
